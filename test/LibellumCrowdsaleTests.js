...
contract('LibellumCrowdsale', function (accounts) {
    ...
    describe('buy tokens when user is whitelisted', function () {
        ...
        describe('when crowdsale has started', function () {
            ...
            it('beneficiary is able to buy tokens and they are available after finish', async function () {
                ...
                (await this.values.libellumTokenContract.balanceOf(this.values.beneficiary)).should.be.bignumber.equal(84 * LIB);
            });
        });
    });
});